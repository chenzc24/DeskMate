"""Add licensed GBIF Pallas occurrence media and rebuild candidate evidence."""
...
from deskmate_baseline.data.source_pilot import run_gbif_pallas  # noqa: E402
...
def main() -> int:
    ...
    with manifest_path.open("r", encoding="utf-8-sig", newline="") as handle:
        base_rows = [row for row in csv.DictReader(handle) if row["source_kind"] != "gbif"]
    ...
    sources = [item for item in prior_report["sources"] if item["source"] != "gbif"]
