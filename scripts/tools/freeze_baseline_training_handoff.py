...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/tools/bootstrap_training_env.ps1
.\\.venv\\Scripts\\python.exe scripts/training/train_provisional_baseline.py
.\\.venv\\Scripts\\python.exe scripts/training/train_provisional_baseline.py --execute
```
